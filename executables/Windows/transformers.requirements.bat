...
ECHO.
ECHO %info_h1%Step 1/5 - Move (cd) to Project Path%ansi_end%
...
ECHO %info_h2% Step 2/5 - Creating MiniConda+TORCH Environment...%ansi_end% 
...
ECHO %info_h2% Step 3/5 - Installing TORCH & Accessories for Environment...%ansi_end% 
call conda install pytorch==1.13.1 torchvision==0.14.1 torchaudio==0.13.1 pytorch-cuda=11.6 -c pytorch -c nvidia -y
...
ECHO %info_h2% Step 4/5 - Installing TORCH & Accessories for Environment...%ansi_end% 
call conda install pytorch==1.13.1 torchvision==0.14.1 torchaudio==0.13.1 pytorch-cuda=11.6 -c pytorch -c nvidia -y
call conda install git -y
call conda install conda-forge::transformers -y
call conda install "ffmpeg<5" -c conda-forge -y
...
ECHO.
ECHO %info_h1% Step 5/5 - Install Project Packages%ansi_end%
IF %arg2_bool% EQU 1 (
